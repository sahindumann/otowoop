...
function FileSelected(file) {
    ...
    var fieldId = RoxyUtils.GetUrlParam('imageID');
   
    $(window.parent.document).find('#' + fieldId).attr('src', file.fullPath);

    $(window.parent.document).find('#' + fieldId).attr('value', file.fullPath);
    $(window.parent.document).find('#' + fieldId).attr('src', file.fullPath);

    $(window.parent.document).find('#' + fieldId+"val").attr('value', file.fullPath);
